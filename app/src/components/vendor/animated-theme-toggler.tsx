...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    // LOCAL PATCH (openlaunch): upstream runs the wipe unconditionally. Every
    // other animation in globals.css is disabled under reduced motion, so this
    // one is too — fall through to an instant, unanimated theme swap.
    // Re-apply if this file is ever re-pulled from the @magicui registry.
    if (
