          ...
          <section id="launch" tabIndex={-1} className={`${shell.anchorSection} ${styles.section}`} aria-labelledby="agents-launch-title">
            ...
            <div className={styles.reference}>
              ...
              <dl className={styles.parameters}>
                <div><dt><code>quote</code></dt><dd>ETH uses address zero. For USDG on Robinhood Chain, use <code>0x5fc5360D0400a0Fd4f2af552ADD042D716F1d168</code> and call <code>findSalt(...)</code> first so the token address sorts above the quote.</dd></div>
