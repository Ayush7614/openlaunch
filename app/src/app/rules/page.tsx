...
const STEPS = [
  ...
  { title: "A market opens", description: "A Uniswap v4 pool pairs your token with ETH, GITLAWB on Base, a tokenized stock (Coinbase stocks on Base, Robinhood Stock Tokens on Robinhood Chain), or USDG on Robinhood Chain. No hook. The pool starts at the market cap you pick.", value: "v4", label: "Uniswap pool" },
        ...
        <div className={styles.article}>
          ...
          <section className={shell.anchorSection} id="know" aria-labelledby="know-heading">
            ...
            <div className={styles.questions}>
              ...
              <details open><summary>What is a GITLAWB-quoted pool?<ChevronDown size={17} aria-hidden="true" /></summary><div><p>GITLAWB is Gitlawb&apos;s token on Base, an ordinary ERC-20 with no transfer restrictions and no issuer switch. Pick it as the quote and buyers pay in GITLAWB, the creator&apos;s trading fee is paid in GITLAWB, and a launch with no beneficiary burns GITLAWB on every trade.</p><p>Dollar figures for these pools come from the Uniswap v4 WETH/GITLAWB pool price and ETH/USD. They are for display and sorting only; nothing on-chain depends on them.</p></div></details>
