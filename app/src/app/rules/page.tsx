        ...
        <div className={styles.article}>
          ...
          <section className={shell.anchorSection} id="know" aria-labelledby="know-heading">
            ...
            <div className={styles.questions}>
              ...
              <details open><summary>Why is my token under &ldquo;quiet launches&rdquo;?<ChevronDown size={17} aria-hidden="true" /></summary><div><p>The home page ranks by facts, not by launch order. A token is <strong>live</strong> once a wallet other than its launcher has traded it in the last 24 hours; buys in the launch block and the next three blocks (snipe bots) don&apos;t count, and neither do the launcher&apos;s own trades. Live tokens rank by outside wallets in the last hour, then today, then by their last outside trade. A launch gets its first hour on the board regardless; after that it sits under quiet launches, one row per wallet, until someone trades it.</p><p>Nothing is hidden: every launch stays in the New tab, in search and in the API. The only way up is a buyer.</p></div></details>
