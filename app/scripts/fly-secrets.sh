...
REQUIRED=(BASE_RPC_URL ROBINHOOD_RPC_URL ARC_RPC_URL NEXT_PUBLIC_SITE_URL NEXT_PUBLIC_LAUNCH_FACTORY NEXT_PUBLIC_LAUNCH_LOCKER LAUNCH_DEPLOY_BLOCK NEXT_PUBLIC_LAUNCH_FACTORY_ROBINHOOD NEXT_PUBLIC_LAUNCH_LOCKER_ROBINHOOD LAUNCH_DEPLOY_BLOCK_ROBINHOOD)
# The Arc contract settings become required once the factory is deployed there (until then the site shows Arc as "Coming soon").
OPTIONAL=(NEXT_PUBLIC_LAUNCH_FACTORY_ARC NEXT_PUBLIC_LAUNCH_LOCKER_ARC LAUNCH_DEPLOY_BLOCK_ARC BASE_B20_RPC_URL LAUNCH_SYNC_CONFIRMATIONS LAUNCH_SYNC_CONFIRMATIONS_ARC LAUNCH_SYNC_LOOP ADMIN_WALLETS IMAGE_PUBLIC_BASE)
